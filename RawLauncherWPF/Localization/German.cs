...
namespace RawLauncherWPF.Localization
{
    sealed class German : Language 
    {
        ...
        public override void Reload()
        {
            ...
            {
                Source = new Uri("/RawLauncherWPF;component/Localization/German.xaml", UriKind.Relative)
            });
        }
        ...
        private void AddExceptionStrings()
        {
            ...
            StringTable.Add("ExceptionGameModExsit", "Der Mod existiert nicht");
